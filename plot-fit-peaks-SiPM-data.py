...
# Load parameters from the JSON file generated by the GUI
with open("params_config.json") as f:
    params = json.load(f)

gain_voltages_to_plot = params["gain_voltages_to_plot"]
crop_off_start = params["crop_off_start"]
crop_off_end = params["crop_off_end"]
counts_threshold = params["counts_threshold"]
peak_spacing_threshold = params["peak_spacing_threshold"]
sigma = params["sigma"]
manual_peak_indices = params["manual_peak_indices"]
