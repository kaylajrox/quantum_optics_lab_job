...
# peak_spacing_threshold = 16
# experiment_duration_analysize = "300s"
# prominence = 0.03  # Ensures peaks stick out at least 2% above surrounding
# sigma = 3.6
#
# # Fixed pulse color map
# pulse_color_map = {
...
#
#
#     # normalized_data = smoothed_data / np.max(smoothed_data)  # normalize between 0 and 1
#     # peaks, _ = find_peaks(
#     #     normalized_data,
#     #     height=counts_threshold / np.max(smoothed_data),
#     #     distance=peak_spacing_threshold,
#     #     prominence=prominence  # new! ensures peaks stick out at least 2% above surrounding
#     # )
#
#     ax.plot(x, smoothed_data, label=label, alpha=0.8, color=color, linestyle=style)
#     counts_at_peaks = smoothed_data[peaks]
