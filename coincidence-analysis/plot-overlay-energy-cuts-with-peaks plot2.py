...
coic_data_directory = "20250507_more_peaks_compare_coicdence"
wiggles_data_directory = "20250507_baseline_data_for_coic_comparison"
font_size = 24
font_size_legend = 14
...
coic_script_dir = Path(__file__).resolve().parent
peak_baseline_script_dir = Path(__file__).resolve().parent
print("script_dir", coic_script_dir)
print("peak_baseline_script_dir", peak_baseline_script_dir)
data_dir = coic_script_dir.parent / "data-photon-counts-SiPM" / coic_data_directory

print("data_dir", data_dir)
weighted_csv_path = coic_script_dir / "weighted_means.csv"
